...
def build_global_POI_checkin_graph(dst_dir, new2raw_rid, raw_rn_dict, mbr, grid_size):
    ...
    for k, v in new2raw_rid.items():
        # print(k+1)
        raw_eid = v
        start_lat, start_lng, end_lat, end_lng, length, level = get_length_level_loc(raw_rn_dict, raw_eid, mbr,
                                                                                     grid_size)
        G.add_node(k,
                   start_lat=start_lat,
                   start_lng=start_lng,
...
if __name__ == '__main__':
    ...
    dst_dir = './data/Chengdu/train/'
    json_dir = './data/Chengdu/extra_data/'
